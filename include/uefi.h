#ifndef LITEOS_UEFI_H
#define LITEOS_UEFI_H

/*
 * 这里只保留加载器实际使用的 UEFI ABI 定义。
 * 定义放在项目内可以避免依赖完整的固件 SDK，同时明确固件接口契约。
 */
#include <stdint.h>
...
typedef EFI_STATUS (EFIAPI *EFI_OPEN_PROTOCOL)(EFI_HANDLE Handle, EFI_GUID *Protocol, VOID **Interface,
...
typedef EFI_STATUS (EFIAPI *EFI_SET_WATCHDOG_TIMER)(UINTN Timeout, UINT64 WatchdogCode,
...
struct EFI_FILE_PROTOCOL {
    ...
    EFI_STATUS (EFIAPI *Open)(struct EFI_FILE_PROTOCOL *This, struct EFI_FILE_PROTOCOL **NewHandle,
                              CHAR16 *FileName, EFI_FILE_HANDLE_MODE OpenMode, UINT64 Attributes);
    ...
    EFI_STATUS (EFIAPI *GetInfo)(struct EFI_FILE_PROTOCOL *This, EFI_GUID *InformationType,
                                 UINTN *BufferSize, VOID *Buffer);
    EFI_STATUS (EFIAPI *SetInfo)(struct EFI_FILE_PROTOCOL *This, EFI_GUID *InformationType,
                                 UINTN BufferSize, VOID *Buffer);
...
typedef struct EFI_GRAPHICS_OUTPUT_PROTOCOL {
    EFI_STATUS (EFIAPI *QueryMode)(struct EFI_GRAPHICS_OUTPUT_PROTOCOL *This, UINT32 ModeNumber,
    ...
    EFI_STATUS (EFIAPI *Blt)(VOID *This, VOID *BltBuffer, UINT32 BltOperation, UINTN SourceX,
                             UINTN SourceY, UINTN DestinationX, UINTN DestinationY, UINTN Width,
                             UINTN Height, UINTN Delta);
    EFI_GRAPHICS_OUTPUT_PROTOCOL_MODE *Mode;
} EFI_GRAPHICS_OUTPUT_PROTOCOL;

typedef struct EFI_RNG_PROTOCOL {
    EFI_STATUS (EFIAPI *GetInfo)(VOID *This, UINTN InformationType, UINTN *Input, VOID *Output);
    EFI_STATUS (EFIAPI *GetRNG)(VOID *This, EFI_GUID *RNGAlgorithm, UINTN Length, UINT8 *Out);
} EFI_RNG_PROTOCOL;
